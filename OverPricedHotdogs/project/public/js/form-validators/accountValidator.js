...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#email-tf'), $('#confirmemail-tf'), $('#user-tf'), $('#pass-tf'), $('#confirmpass-tf')];
	this.controlGroups = [$('#email-cg'), $('#confirmemail-cg'), $('#user-cg'), $('#pass-cg'), $('#confirmpass-cg')];
...
AccountValidator.prototype.validateForm = function()
{
	...
	if(this.validateUser(this.formFields[2].val()) == false) {
		this.controlGroups[2].addClass('error');
		e.push('Username Should Be At Least 6 Characters')
	}
